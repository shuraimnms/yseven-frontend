...
const UsersPage = () => {
  ...
  const fetchUsers = async () => {
    try {
      ...
      const response = await fetch(`${getApiBaseUrl()}/admin/customers`, {
        credentials: 'include',
        headers: {
  ...
  const toggleUserStatus = async (userId: string, currentStatus: boolean) => {
    try {
      const response = await fetch(`${getApiBaseUrl()}/admin/customers/${userId}/status`, {
        method: 'PATCH',
        credentials: 'include',
        headers: {
          'Content-Type': 'application/json',
  ...
  const changeUserRole = async (userId: string, newRole: 'admin' | 'customer') => {
    try {
      ...
      const response = await fetch(`${getApiBaseUrl()}/admin/customers/${userId}/role`, {
        method: 'PATCH',
        credentials: 'include',
        headers: {
          'Content-Type': 'application/json',
  ...
  const fetchUserDetails = async (userId: string) => {
    try {
      ...
      const response = await fetch(`${getApiBaseUrl()}/admin/customers/${userId}`, {
        credentials: 'include',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${Cookies.get('accessToken')}`
  ...
  const resetUserPassword = async (userId: string, password: string) => {
    try {
      ...
      const response = await fetch(`${getApiBaseUrl()}/admin/customers/${userId}/password`, {
        method: 'PATCH',
        credentials: 'include',
        headers: {
          'Content-Type': 'application/json',
