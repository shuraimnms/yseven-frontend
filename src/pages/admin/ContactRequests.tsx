...
export default function ContactRequests() {
  ...
  const fetchContacts = async () => {
    try {
      ...
      const response = await fetch(`${getApiBaseUrl()}/contact?${params}`, {
        credentials: 'include',
        headers: {
  ...
  const fetchStats = async () => {
    try {
      const response = await fetch(`${getApiBaseUrl()}/contact/stats`, {
        credentials: 'include',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${Cookies.get('accessToken')}`
  ...
  const handleUpdateContact = async () => {
    ...
    try {
      const response = await fetch(`${getApiBaseUrl()}/contact/${selectedContact._id}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${Cookies.get('accessToken')}`
  ...
  const handleDeleteContact = async (contactId: string) => {
    ...
    try {
      const response = await fetch(`${getApiBaseUrl()}/contact/${contactId}`, {
        method: 'DELETE',
        credentials: 'include',
        headers: {
          'Content-Type': 'application/json',
