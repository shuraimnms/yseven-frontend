...
const EditProductDialog = ({ product, isOpen, onClose, onProductUpdated, existingCategories }: EditProductDialogProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await adminAPI.products.update(product._id, {
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto bg-charcoal border-gold/30">
        <DialogHeader>
          <DialogTitle className="text-cream flex items-center">
            <Edit className="w-5 h-5 mr-2 text-gold" />
            Edit Product
          </DialogTitle>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-cream/60 text-sm">
                    SKU: {product.sku} • {formData.category || 'Category'}
                  </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="stock" className="text-cream">Stock Quantity *</Label>
                <Input
                  id="stock"
                  type="number"
                  min="0"
