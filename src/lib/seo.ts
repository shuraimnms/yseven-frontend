...
export const seoConfig = {
  defaultTitle: 'YSeven Foods – Premium Global Food Products | One Brand. Endless Flavor',
  titleTemplate: '%s | YSeven Foods',
  defaultDescription: 'Discover YSeven Foods\' premium product collection - peri-peri, sambal, mayonnaise, hot sauce & gourmet condiments. Authentic global flavors delivered worldwide. Shop now!',
  siteUrl: 'https://ysevenfoods.com',
  defaultImage: '/og-image.jpg',
  siteName: 'YSeven Foods',
  twitterHandle: '@YSevenFoods',
  facebookAppId: '1234567890',
  language: 'en',
  locale: 'en_US',
  type: 'website',
  author: 'YSeven Foods',
  publisher: 'YSeven Foods',
  ...
  keywords: {
    ...
    branded: ['YSeven Foods', 'YSeven condiments', 'YSeven hot sauce', 'YSeven mayonnaise', 'YSeven peri peri']
  },
  schema: {
    organization: {
      ...
      sameAs: [
        'https://facebook.com/YSevenFoods',
        'https://instagram.com/YSevenFoods',
        'https://twitter.com/YSevenFoods',
        'https://linkedin.com/company/ysevenfoods'
      ]
    }
  }
};
...
export const generateSEO = (data: Partial<SEOData> = {}): SEOData => {
  const title = data.title 
    ? (data.title.includes('YSeven') ? data.title : `${data.title} | YSeven Foods`)
...
export const pageSEO = {
  home: generateSEO({
    title: 'YSeven Foods – Premium Global Food Products | One Brand. Endless Flavor',
    description: 'Discover YSeven Foods\' premium product collection - peri-peri, sambal, mayonnaise, hot sauce & international condiments. Authentic global flavors delivered worldwide. Shop now!',
    keywords: 'premium sauces, peri peri sauce online, sambal sauce buy, mayonnaise brand, hot sauce premium, condiments gourmet, YSeven Foods, international sauces',
    path: '/',
    ogType: 'website'
  }),

  about: generateSEO({
    title: 'About YSeven Foods - Premium Global Food Brand Story',
    description: 'Learn about YSeven Foods - premium global food brand crafting authentic international flavors. Discover our mission, quality standards & commitment to excellence.',
    keywords: 'about YSeven Foods, premium food brand, food company story, food manufacturing, quality standards, international condiments',
    path: '/about',
    ogType: 'website'
  }),

  products: generateSEO({
    title: 'Premium Products - Peri-Peri, Sambal, Mayonnaise & More',
    description: 'Explore YSeven Foods\' complete range of premium sauces & condiments. Peri-peri, sambal, mayonnaise, hot sauce, BBQ sauce & international flavors. Shop authentic taste.',
    keywords: 'YSeven products, peri peri sauce premium, sambal sauce authentic, mayonnaise gourmet, hot sauce collection, international sauces, premium condiments',
    path: '/products',
    ogType: 'website'
  }),

  shop: generateSEO({
    title: 'Shop Premium Products Online - YSeven Foods Global Store',
    description: 'Buy premium YSeven Foods products online. Peri-peri, sambal, mayonnaise, hot sauce & more. Fast worldwide delivery, secure payment. Free shipping over $50.',
    keywords: 'buy sauces online, YSeven shop, premium condiments online, peri peri sauce buy, sambal sauce order, mayonnaise premium',
    path: '/shop',
    ogType: 'website'
  }),

  contact: generateSEO({
    title: 'Contact YSeven Foods - Premium Food Supplier & Partner',
    description: 'Contact YSeven Foods for bulk orders, partnerships, wholesale inquiries & customer support. Premium food supplier for restaurants & retailers worldwide.',
    keywords: 'contact YSeven Foods, bulk orders, wholesale condiments, food supplier, restaurant partnerships, premium distributor',
    path: '/contact',
    ogType: 'website'
  }),

  blog: generateSEO({
    title: 'YSeven Foods Blog - Recipes, Tips & Global Flavor Inspiration',
    description: 'Discover recipes, cooking tips & flavor inspiration from YSeven Foods. Learn to use peri-peri, sambal, mayonnaise & international sauces in your cooking.',
    keywords: 'sauce recipes, cooking tips, YSeven blog, peri peri recipes, sambal recipes, mayonnaise uses, hot sauce cooking, international cuisine',
    path: '/blog',
    ogType: 'website'
  }),
  ...
  hotSauces: generateSEO({
    ...
    description: 'Explore YSeven Foods\' premium hot sauce collection. Peri-peri, ghost pepper, carolina reaper, sriracha & international spicy sauces. Authentic heat, premium quality.',
  ...
  mayonnaise: generateSEO({
    ...
    description: 'Discover YSeven Foods\' gourmet mayonnaise collection. Garlic, chipotle, truffle, sriracha mayo & more. Premium quality, restaurant-grade spreads & condiments.',
  ...
  international: generateSEO({
    ...
    description: 'Explore YSeven Foods\' authentic international sauce collection. Sambal, harissa, chimichurri, gochujang, tahini & more. Genuine global flavors, premium quality.',
  ...
  bbq: generateSEO({
    ...
    description: 'Discover YSeven Foods\' premium BBQ sauce collection. Kansas City, Carolina, Texas styles & international BBQ flavors. Perfect for grilling & smoking.',
...
export const generateProductSEO = (product: any): SEOData => {
  const productKeywords = [
    ...
    `YSeven ${product.category.toLowerCase()}`,
    'gourmet sauce',
    'artisan condiment'
  ].join(', ');

  return generateSEO({
    title: `${product.name} - Premium ${product.category} | YSeven Foods`,
...
export const generateCategorySEO = (category: string, products: any[]): SEOData => {
  const categoryKeywords = [
    ...
    `YSeven ${category.toLowerCase()}`,
    'gourmet sauce',
    'artisan condiment'
  ].join(', ');

  return generateSEO({
    title: `Premium ${category} Collection - YSeven Foods`,
    description: `Explore YSeven Foods' premium ${category.toLowerCase()} collection. ${products.length}+ authentic flavors, restaurant quality. Shop ${category.toLowerCase()} sauces online with fast delivery.`,
...
export const seoKeywords = {
  ...
  branded: [
    'YSeven Foods',
    'YSeven peri peri sauce',
    'YSeven mayonnaise',
    'YSeven hot sauce collection',
    'YSeven sambal sauce',
    'YSeven international sauces',
    'YSeven bbq sauce',
    'YSeven gourmet condiments',
    'YSeven subscription',
    'YSeven gift sets'
  ]
};